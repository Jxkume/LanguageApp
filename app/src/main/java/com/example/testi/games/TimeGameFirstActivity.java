...
public class TimeGameFirstActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Etsitään ja tallennetaan Words/Timegame path databaseReference muuttujaan
        databaseReference = FirebaseDatabase.getInstance().getReference("Words/Timegame");
    ...
    private void showNextQuestion() {
        if (currentQuestionIndex < roundsToPlay) {
            ...
            int questionImageResource = getResources().getIdentifier(corrAnswerWithNoSpacesAndSpecCharacters.toLowerCase() + "timegame", "drawable", getPackageName());
            ...
            for (int i = 0; i < 4; i++) {
                if (!assignedOptions[i]) {
                    ...
                    int incorrectImageResource = getResources().getIdentifier(incorrAnswerWithNoSpacesAndSpecCharacters.toLowerCase() + "timegame", "drawable", getPackageName());
